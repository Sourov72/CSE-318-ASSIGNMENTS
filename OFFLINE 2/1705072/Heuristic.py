...
class Heurisitic:
    ...
    def _heuristic(self, m, currentplayer, type):
        ...
        if(type == 1):
            ...
            return self._heuristic7(m, currentplayer)
    ...
    def _heuristic5(self, m, currentplayer):
        ...
        return w1 * self._heuristic1(m, currentplayer) + w2 * (myside - opponentside) + w3 * (m._getcapturemove(currentplayer))
    ...
    def _heuristic6(self, m, currentplayer):
        ...
        return w1 * self._heuristic1(m, currentplayer) + w2 * (myside - opponentside) + w3 * (m._getfreemove(currentplayer)) + w4 * (m._getcapturemove(currentplayer))
